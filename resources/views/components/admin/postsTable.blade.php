    ...
    <table class="w-full border-collapse bg-primaryColor-400 text-left text-sm text-white">
        ...
        <tbody class="divide-y divide-gray-100 border-t border-gray-100 ">
            ...
            @foreach ($posts as $post)
                <tr class="hover:bg-mainColor-600 transition-all">
              ...
              <div class="relative w-full max-w-md max-h-full">
                  <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                      ...
                      <div class="p-6 text-center">
                          ...
                          <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Czy na pewno chcesz usunąć ten post?</h3>
                          <div class="flex justify-center items-center">

                              <form action="{{ route('admin.destroy', $post->slug) }}" method="POST">
                                @csrf
                                @method('DELETE')
                          <button data-modal-hide="popup-modal" type="sumbit" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2 transition-colors">
                              Usuń
                            </button>
                        </form>
...
<div class="absolute bottom-5 right-5 ">
    ...
    <a href="{{route('admin.create')}}" class="ml-2"><button type="button"
            class="text-white bg-mainColor-400 hover:bg-mainColor-600 focus:ring-4 focus:outline-none focus:ring-white rounded-full  px-2 py-1 text-center inline-flex items-centertransition-colors">
