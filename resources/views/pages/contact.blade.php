<x-layouts.master>
    @section('title', 'Podaj Łapsie -  Skontaktuj się ze mną | Behawiorysta i Szkolenie Psów w Nowym Targu i na Podhalu')
    @section('description', 'Jeśli masz pytania lub chcesz umówić się na konsultacje behawiorystyczne, szkolenie psa lub petsitting, skontaktuj się ze mną. Jako doświadczony behawiorysta i trener psów w Nowym Targu oferuję profesjonalną pomoc. Czekam na Twój kontakt!')
      <main class="pt-10 ">
            ...
            <x-sectionWrapper  id="kontakt" :title="'Skontaktuj się ze mną'" class=" min-w-full  py-24 mb-0">
                ...
                <div class="mt-10 md:mt-14 xs:m-6 px-3 md:px-12 py-6 lg:w-1/2 lg:border-4 border-black rounded-md  bg-mainColor-400 overflow-hidden order-2 lg:order-1 md:opacity-0 animation-trigger--2">
                    ...
                    <div class=" flex flex-col text-center mt-6">
                        ...
                        <span class="text-xl font-bold mb-2">Dziękuję za wiadomość!</span>
                        <span class="text-xl font-bold">Odpowiem najszybciej jak to możliwe!</span>
                    </div>
                @endif
                </div>
