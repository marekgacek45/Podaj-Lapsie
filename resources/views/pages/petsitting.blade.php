<x-layouts.master>
    ...
    @section('description', 'Oferuję profesjonalny petsitting w Nowym Targu. Jako doświadczona opiekunka zapewniam bezpieczne i kochające środowisko dla Twojego pupila w czasie Twojej nieobecności. Skontaktuj się ze mną, a Twój zwierzak będzie w najlepszych rękach!')
      <main class="pt-16 ">
  
          <x-sectionBg class="bg2 bg-gray-800">
  
              <x-sectionWrapper id="konsultacje" :title="'Petsitting'" class="px-4 md:px-12">
