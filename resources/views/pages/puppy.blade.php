<x-layouts.master>
    @section('title', 'Podaj Łapsie - Budowanie relacji ze szczeniakiem, szkolenie psów w Nowym Targu i na Podhalu')
    @section('description', 'Zarezerwuj konsultacje behawiorystyczne i szkoleniowe z doświadczonym ekspertem ds. zachowania psów w Nowym Targu. Oferuję profesjonalne porady oraz indywidualne podejście, które pomogą w poprawie zachowania Twojego pupila.')
      <main class="pt-16 ">
          ...
          <x-sectionBg class="bg2 bg-gray-800">
              ...
              <x-sectionWrapper id="konsultacje" :title="'Budowanie więzi i relacji'" class="px-4 md:px-12">
