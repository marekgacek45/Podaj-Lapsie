<x-layouts.master>
    @section('title', 'Podaj Łapsie - Profesjonalna Pomoc w Wyborze Psa | Ekspert w Nowym Targu i na Podhalu')
    @section('description', 'Znajdź idealnego pupila dzięki naszej profesjonalnej pomocy w wyborze psa. Jako ekspert ds. zachowania psów w Nowym Targu oferuję wsparcie i wskazówki, które pomogą Ci znaleźć psa, który najlepiej pasuje do Twojego stylu życia. Skonsultuj się ze mną już dziś!')
      <main class="pt-16 ">
  
          <x-sectionBg class="bg2 bg-gray-800">
  
              <x-sectionWrapper id="konsultacje" :title="'Profesjonalna pomoc w wyborze psa'" class="px-4 md:px-12">
