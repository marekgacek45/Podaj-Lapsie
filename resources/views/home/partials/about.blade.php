<x-sectionBg class="bg2 bg-gray-800">
    ...
    <x-sectionWrapper id="o_mnie" :title="'O mnie'">
        ...
        <x-cardTextRight :title="'Kilka słów o mnie'" src="{{ asset('images/images/4.jpg') }}" :alt="'Izabela wraz ze swoim psem Pajdkiem nad rzeką'">
        ...
        <x-cardTextLeft :title="'Jak to się zaczeło?'" src="{{ asset('images/images/2.jpg') }}" :alt="''">
        ...
        <x-buttons.btnPrimary :href="route('about')" class="md:px-24 md:py-4 text-xl mt-12">
            Dowiedz się więcej
